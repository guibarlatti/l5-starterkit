...
define([
    'marionette',
    'underscore',
    'tpl!modules/reports/templates/register.html',
    ...
    return Marionette.ItemView.extend({
        ...
        onRender: function () {
            ...
            if (this.model.get('id')) {
                app.dataStore.ajax({
                    type: 'GET',
                    url: app.config.getEndPoint('reports/' + this.model.get('id'))
        ...
        save: function (e) {
            ...
            var request,
                ...
                endpoint = app.config.getEndPoint('reports');
            ...
            request.done(function (result) {
                ...
                if (result.status === 'success') {
                    ...
                    app.vent.trigger('reports:refreshList', result.data);
