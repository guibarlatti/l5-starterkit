...
define([
    'tpl!modules/employeeProfile/templates/register.html',
    'modules/employeeProfile/config/config',
    ...
    return Marionette.ItemView.extend({
        ...
        onRender: function () {
            ...
            app.dataStore.ajax({
                type: 'GET',
                url: app.config.getEndPoint('employeeProfile/show')
        ...
        save: function (e) {
            ...
            var request,
                ...
                endpoint = app.config.getEndPoint('employeeProfile');
            ...
            request.done(function (result) {
                ...
                if (result.status === 'success') {
                    ...
                    app.vent.trigger('employeeProfile:refreshList', {id: result.data});
